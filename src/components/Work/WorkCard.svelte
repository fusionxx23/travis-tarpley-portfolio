...
<article
  class="flex max-w-xl flex-col items-start justify-between relative rounded-3xl p-7 border border-gray-700/70 bg-background-100"
>
  <BorderBeam size={150} duration={12} />
  <div class="flex items-center gap-x-4 text-xs">
    <time datetime="2020-03-16" class="text-gray-300"
      >June 7, 2024</time
    >
    <a
  ...
  <div class="group relative">
    ...
    >
      Welcome to Svelte Animation website. This website
      includes Qualtiy Tailwind CSS and Framer Motion
      Components. Inspired from <span
